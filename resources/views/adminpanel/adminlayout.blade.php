    ...
    <div class="dashboard-container">
        <aside class="sidebar">
            ...
            <nav>
                ...
                <a href="{{ route('userindex') }}" class="{{ request()->routeIs('userindex') ? 'active' : '' }}"><i class="fa-solid fa-user"></i> Users</a>
                <a href="#" class="{{ request()->routeIs('orders') ? 'active' : '' }}"><i class="fa-solid fa-shopping-cart"></i> Orders</a>
                <a href="#" class="{{ request()->routeIs('products') ? 'active' : '' }}"><i class="fa-solid fa-box"></i> Products</a>
